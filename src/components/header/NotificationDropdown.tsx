...
import { useEscalatedNotifications } from "@/hooks/useEscalatedNotifications";

export default function NotificationDropdown() {
  const { notifications, hasNew, setHasNew } = useEscalatedNotifications();
  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex h-[400px] w-[380px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
      >
                ...
                >
                  <span className="block">
                    <span className="text-sm text-gray-700 dark:text-gray-200">
                      🚨 Una conversación requiere atención 
                    </span>
                    <span className="block text-xs text-gray-500 dark:text-gray-400">
    
                      {n.contact?.name || "Contacto desconocido"} - {n.contact?.phone_number || "Sin número"} <br />
